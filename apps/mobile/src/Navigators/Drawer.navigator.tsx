...
import ListPotsScreen from "../Entities/Pots/List.pots.screen";
import ShowPotsScreen from "../Entities/Pots/Show.pots.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListPotsScreen"
            component={ListPotsScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowPotsScreen"
          component={ShowPotsScreen}
          options={screenOptions}
        />
